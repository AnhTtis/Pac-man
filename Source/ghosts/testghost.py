...
HEIGHT = int(screen_info.current_h * .9)
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Ghost Drawing")

# Màu sắc
BACKGROUND_COLOR = (0, 0, 0)  # Màu nền
BLOCK_SIZE = HEIGHT / 100    # Kích thước mỗi ô
PIXEL_SIZE = BLOCK_SIZE / len(ghost_appearance_matrix[0])
...
while running:
    ...
    blue_ghost.display(screen, HEIGHT)
    red_ghost.display(screen, HEIGHT)
    pink_ghost.display(screen, HEIGHT)
    yellow_ghost.display(screen, HEIGHT)
