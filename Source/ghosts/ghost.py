import pygame
from typing import List, Tuple, Dict, Set, Optional, LiteralString
from maze import Maze
import copy

class Ghost:
    def __init__(self, name: LiteralString, pos: List[int], size: Tuple[int, int], color):
        self.name = name
...
class BlueGhost(Ghost):
    def __init__(self, name: LiteralString, pos: List[int], size: Tuple[int, int]):
        super().__init__(name, pos, size, (0, 0, 255))
